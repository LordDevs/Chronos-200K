...
| `VAULT ARCHIVE <planet>` | `vault:archive:<planet>` | TAP → EvolutionEngine → persist |
...
Implementation: [`ObservatoryService`](../Backend/src/ObservatoryService.java), AIML [`observatory_cmds.aiml`](../Backend/ab/bots/chronos/aiml/observatory_cmds.aiml).
